...
#define NUMESTADOS 17 //15
#define NUMCOLS 15 //13
#define TAMLEX 32+1
#define TAMNOM 20+1
...
void Expresion(REG_EXPRESION *presul)
{
    ...
    Termino(&operandoIzq);//Primaria(&operandoIzq);

    for (t = ProximoToken(); t == SUMA || t == RESTA; t = ProximoToken())
    {
        OperadorAditivo(op);
        Termino(&operandoDer); //Primaria(&operandoDer);
...
void Match(TOKEN t)
{
    ...
    flagToken = 0; //leo un nuevo token
}
...
void Comenzar(void)
{
    ...
    //printf("Iniciando el proceso de compilacion...");
}
...
TOKEN scanner()
{
    int tabla[NUMESTADOS][NUMCOLS] = {
     //        L    D   +   -   (   )   ,   ;   :   =  fdt sp otro  *   /
        /*0*/{ 1,   3,  5,  6,  7,  8,  9, 10, 11, 14, 13,  0, 14, 15, 16},
        ...
        /*11*/{ 14, 14, 14, 14, 14, 14, 14, 14, 14, 12, 14, 14, 14,14, 14},
